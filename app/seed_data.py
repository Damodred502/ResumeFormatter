...
def seed():
    with SessionLocal() as s:
        ...
        sec_i = Section(library_version_id=v1.id, code="I",organization = "N/A", title="General Information", introduction="U.S. Air Force veteran and results-driven Technical Product Manager with 10+ years of experience leading digital transformation initiatives across highly regulated sectors. Proven success in modernizing legacy systems and accelerating user acquisition through cloud-native platforms, AI-enhanced development workflows, and agile product delivery. Adept at aligning product strategy with customer needs and organizational goals, driving cross-functional collaboration, and delivering secure, scalable solutions. Experience in modernizing government systems within high-compliance environments directly translates to healthcare-adjacent domains like Medicare Advantage, where data integrity, user trust, and regulatory alignment are critical to growth.", order=1)
        sec_a = Section(library_version_id=v1.id, code="A",organization = "Administrative Office of the Courts - KY", title="Applications Development Officer", introduction="Program manager for 280+ bespoke applications vital to Kentucky’s Court of Justice, managing 57 senior developers across 8 agile teams. Required to think strategically, foster clear communication across technical and judicial stakeholders, and track progress through agile metrics and governance frameworks to ensure delivery of modernization goals.", order=2)
        sec_b = Section(library_version_id=v1.id, code="B",organization = "BrickBridge Consulting LLC",title="Founder/Product Manager", introduction="Partnered with platform engineering teams to design scalable SaaS and ERP tools leveraging AI, APIs, and microservices.  Lead customer discovery, ideation, and agile software development. Manage seven bespoke projects at Brick Bridge Consulting, mentoring technical talent and scaling the team to 17 developers while delivering customized, user-driven solutions with training and support.", order=3)
        sec_c = Section(library_version_id=v1.id, code="C",organization = "Navigate Enterprise Center", title="Director", introduction="Acted as program manager, strategist, and lead fundraiser.", order=4)
        ...
        s.add_all(
            [
                ...
                Bullet(section_id=sec_a.id, text="Organized process improvement through Agile workflow rearchitecture, increasing story velocity by 30 percent and reducing cycle time by 40% across delivery teams."),
